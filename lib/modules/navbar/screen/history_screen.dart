...
class HistoryScreen extends StatefulWidget {
  ...
  const HistoryScreen({super.key, this.onNavigateToHome, this.onCountChanged});
      ...
      child: filteredTrips.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildTripCard(context, trip, theme, loc, isBangla);
              },
            ),
    );
  }

  Widget _buildTripCard(BuildContext context, RentalTripModel trip, ThemeData theme, AppLocalizations loc, bool isBangla) {
