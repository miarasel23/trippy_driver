...
android {
    ...
    defaultConfig {
        applicationId = "com.trippy.rider"
    ...
    buildTypes {
        release {
            // Use the proper release keystore (not the debug key)
            signingConfig = signingConfigs.getByName("release")
            // Disable minification/shrinking to avoid R8 breaking plugins
